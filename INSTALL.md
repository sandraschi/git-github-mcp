...
4. Start the server:
   ...
   uv run python -m git_github_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn git_github_mcp.server:app --port 10702
   ```
5. Open `http://localhost:10702` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/git-github-mcp/issues) |
