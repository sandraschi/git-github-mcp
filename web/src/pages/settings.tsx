  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      >
        ...
        {loading ? (
          ...
          <div style={{ background: "var(--bg-2)" }}>
            ...
            <StatusRow
              label="gh CLI"
              ok={status?.gh_available}
              detail={status?.gh_version}
            />
      ...
      >
        ...
        <div
          className="mono text-xs space-y-1"
        ...
        >
          ...
          <div>
            <span style={{ color: "var(--text-dim)" }}>fastmcp </span>3.4.4+
          </div>
          <div>
            <span style={{ color: "var(--text-dim)" }}>mcp port </span>stdio
            (Claude Desktop)
          </div>
          <div>
          ...
          <div>
            ...
            {status?.git_ops ?? "43"} actions
          </div>
          <div>
            <span style={{ color: "var(--text-dim)" }}>github ops </span>
            {status?.github_ops ?? "58"} actions
          </div>
          <div>
            <span style={{ color: "var(--text-dim)" }}>repo </span>
            <a
              href="https://github.com/sandraschi/git-github-mcp"
              target="_blank"
              rel="noreferrer"
      ...
      {!status?.gh_authenticated && !loading && (
        ...
        >
          ...
          <p className="mono text-xs" style={{ color: "var(--text-muted)" }}>
            Run <span className="text-white">gh auth login</span> in a terminal
            to enable GitHub features. Issues, PRs, releases and workflow
